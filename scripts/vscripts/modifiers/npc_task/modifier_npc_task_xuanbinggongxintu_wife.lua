modifier_npc_task_xuanbinggongxintu_wife = class({})

local public = modifier_npc_task_xuanbinggongxintu_wife
...
function public:GetModifierAura()
	return "modifier_npc_task_xuanbinggongxintu_wife_hero_touching"
end
