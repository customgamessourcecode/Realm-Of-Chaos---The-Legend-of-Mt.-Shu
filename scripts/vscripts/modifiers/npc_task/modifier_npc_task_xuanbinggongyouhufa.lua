modifier_npc_task_xuanbinggongyouhufa = class({})

local public = modifier_npc_task_xuanbinggongyouhufa
...
function public:GetModifierAura()
	return "modifier_npc_task_xuanbinggongyouhufa_hero_touching"
end
