modifier_npc_task_xuanbinggongzuohufa = class({})

local public = modifier_npc_task_xuanbinggongzuohufa
...
function public:GetModifierAura()
	return "modifier_npc_task_xuanbinggongzuohufa_hero_touching"
end
