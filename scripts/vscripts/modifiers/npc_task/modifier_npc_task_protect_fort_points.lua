modifier_npc_task_protect_fort_points = class({})

local public = modifier_npc_task_protect_fort_points
...
function public:GetModifierAura()
	return "modifier_npc_task_protect_fort_points_hero_touching"
end
