modifier_npc_task_tiandaomenyunyoudizi = class({})

local public = modifier_npc_task_tiandaomenyunyoudizi
...
function public:GetModifierAura()
	return "modifier_npc_task_tiandaomenyunyoudizi_hero_touching"
end
