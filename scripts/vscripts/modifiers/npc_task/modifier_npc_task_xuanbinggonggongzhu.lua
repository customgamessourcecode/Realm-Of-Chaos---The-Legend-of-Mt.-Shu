modifier_npc_task_xuanbinggonggongzhu = class({})

local public = modifier_npc_task_xuanbinggonggongzhu
...
function public:GetModifierAura()
	return "modifier_npc_task_xuanbinggonggongzhu_hero_touching"
end
